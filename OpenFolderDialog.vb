...
Public Class OpenFolderDialog
    ...
    Private Function ShowVistaDialog(ByVal owner As IWin32Window) As DialogResult
        ...
        If Me.InitialFolder IsNot Nothing Then
            ...
            'IShellItem
#Disable Warning BC42030 ' La referencia pasa una variable ates de que se le haya asignado un valor
            If NativeMethods.SHCreateItemFromParsingName(Me.InitialFolder, IntPtr.Zero, riid, ppv:=directoryShellItem) = NativeMethods.S_OK Then
#Enable Warning BC42030 ' La referencia pasa una variable ates de que se le haya asignado un valor
        ...
        If Me.DefaultFolder IsNot Nothing Then
            ...
            'IShellItem
#Disable Warning BC42030 ' La referencia pasa una variable ates de que se le haya asignado un valor
            If NativeMethods.SHCreateItemFromParsingName(Me.DefaultFolder, IntPtr.Zero, riid, ppv:=directoryShellItem) = NativeMethods.S_OK Then
#Enable Warning BC42030 ' La referencia pasa una variable ates de que se le haya asignado un valor
...
#Disable Warning BC42030 ' La referencia pasa una variable ates de que se le haya asignado un valor
            If frm.GetResult(ppsi:=shellItem) = S_OK Then
#Enable Warning BC42030 ' La referencia pasa una variable ates de que se le haya asignado un valor
